...
The agents, models, prompts, and workflows I use day to day. Local setups, hosted tools, the weird edge cases I hit while wiring them together.

My work output multiplies when the tooling is sharp. When it's dull, I waste hours fighting the tools instead of doing the work. This Topic is where I keep that signal-to-noise ratio honest.
